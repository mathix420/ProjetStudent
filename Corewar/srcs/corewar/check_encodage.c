...
/*   Updated: 2019/03/05 17:29:04 by trlevequ         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_encodage(t_process *process)
{
	...
	while (++param < g_op_tab[process->index].nb_param)
	{
		...
		else if ((REGISTRE >> (param * 2) & encodage) == (REGISTRE >> (param * 2)))
